            ...
            <div class="row">
                <div class="col-sm-offset-8 col-sm-4">
                    <ul class="list-unstyled pull-right">
                        <li><a href="career.php?q=logout">Sign Out</a></li>
                ...
                <div class="col-sm-offset-2 col-sm-8 clearfix">
                    <div class="sign_in clearfix">
                        <div class="sign_in_text">
                            <h3><b>Hello, <?php $user->get_fullname($uid); ?> Submit your CV and Image below!</b></h3><br>
                        
                        </div>
                        <br>

                        <form class="form-horizontal clearfix" action="careerprocess.php" method="post" enctype="multipart/form-data">
