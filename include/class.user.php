	...
	class User{
	    ...
	    public function user_logout() {
	        ...
	        session_destroy();
	    		...
	    		/*** for career ***/
		public function career_submit($username,$photo){

				$sql4="INSERT INTO career_submission SET career_name='$username', career_photo='$photo'";
				$result = mysqli_query($this->db,$sql4) or die(mysqli_connect_errno()."Data cannot inserted");
		}
